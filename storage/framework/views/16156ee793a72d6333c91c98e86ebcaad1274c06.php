<header class="main-header">
    ...
    <a href="<?php echo e(url('/dashboard')); ?>" class="logo">
        ...
        <span class="logo-mini"><?php if(!empty(auth()->user()->avatar)): ?>
                        <img src="<?php echo e(asset('public/profile_picture/'.auth()->user()->avatar)); ?>" class="user-image" alt="User Image">
                        <?php else: ?>
                        <img src="<?php echo e(asset('public/profile_picture/blank_profile_picture.png')); ?>" class="user-image" alt="User Image">
                        <?php endif; ?></span>
                ...
                <li class="dropdown user user-menu">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li class="user-header">
                            <?php if(!empty(auth()->user()->avatar)): ?>
                            <img src="<?php echo e(asset('public/profile_picture/'.auth()->user()->avatar)); ?>" class="img-circle" alt="User Image">
                            <?php else: ?>
                            <img src="<?php echo e(asset('public/profile_picture/blank_profile_picture.png')); ?>"  class="img-circle" alt="User Image">
                            <?php endif; ?>
                            <p>
...
</header><?php /**PATH /Users/ashfaqhahmed/Sites/laraProjects/hrm-demo/resources/views/administrator/layouts/header.blade.php ENDPATH**/ ?>